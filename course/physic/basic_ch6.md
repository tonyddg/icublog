...
1. 越靠近中心, $i$ 越小, 条纹级数越高, 相应的, 边缘级数小
1. 增大 $d$ 时, $\delta$ 增大, 中心圆环的级数增大, 表现为圆环从中心涌出
1. 根据 $\delta=2nd\cos\gamma=k\lambda$, 边缘条纹的级数 $k$ 较小, 对应的 $\gamma$ 较大, 根据 $y=\cos\theta$ 的图像可得, ==边缘条纹的级数变化快, 间距窄, 中心条纹间距宽==
...
#### 劈尖干涉
当 $\theta\approx 0$, 距离棱角 $l$ 处的光程差为 $$\delta=2nl\tan\theta\approx 2nl\theta=k\lambda(亮条纹)$$
